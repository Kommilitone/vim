...
sudo apt-get update
sudo apt-get install autoconf automake cmake g++ gettext libncurses5-dev libtool libtool-bin libunibilium-dev ninja-build pkg-config python-pip python3-pip software-properties-common unzip
